defmodule AxonWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: AxonWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AxonWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AxonWeb.Gettext, "errors", msg, opts)
    end
  end
